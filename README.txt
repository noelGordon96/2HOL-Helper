...
- Copy the entire "2HOL Helper" folder to your local system
- Double click the "Installer.exe" file and navigate to your 2HOL game folder
...
- This program requires no special procedures to uninstall. Simply deleting the folder will remove the program and all its settings from your computer.
